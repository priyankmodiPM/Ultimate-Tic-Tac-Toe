...
class Team65:
	...
	def evaluation(self, board, old_move):
		...
		for i in range(0, 3):
			...
			for j in range(0, 3):
				if board.board_status[i][j] == '-':
					countd += 1
				elif board.board_status[i][j] == 'o':
					counto += 1
				elif board.board_status[i][j] == 'x':
					countx += 1
		...
		countd = 0
		for i in range(0, 3):
			if board.board_status[i][i] == '-':
				countd += 1
			elif board.board_status[i][i] == 'o':
				counto += 1
			elif board.board_status[i][i] == 'x':
				countx += 1
		...
		countd = 0
		for i in range(0, 3):
			if board.board_status[i][3 - i] == '-':
				countd += 1
			elif board.board_status[i][3 - i] == 'o':
				counto += 1
			elif board.board_status[i][3 - i] == 'x':
				countx += 1
	...
	def move(self, board, old_move, flag):
		#old_move[0] = old_move[1];
		#old_move[1] = old_move[2];
		self.symbol = flag
